...
void CLCD_voidSendNumber(u32 Copy_u8Number)
{
	...
	{
		Local_u8Quotient = Copy_u8Number/MATH_u32Power(10,++Local_u8NumOfDigits);
	}
...
{
	CLCD_voidSendCommand(0xb00000001);
}
...
void CLCD_voidInit(void)
{
	...
	/*Function set command : 2 lines, 5*8 Front size*/
	CLCD_voidSendCommand(0b00111000); 
	
	/*Display ON/OFF control: display enable, cursor, blinking*/
